...
void main() {
	...
	cout << endl << "   Обход в глубину списков смежности" << endl;
	cout << "   Введите размерность матрицы: " << " ";
	cin >> size;
	cout << endl;
	...
	for (int i = 0; i < size; i++)
		versh[i] = 0;
	cout << endl << "   Введите номер вершины, с которой хотите начать обход: ";
	num = 0;
	cin >> num;
	...
	cout << endl << "   Обход в глубину нерекурсивным способом матриц" << endl;
	cout << "   Введите размерность матрицы: " << " ";
	cin >> size;
	cout << endl;
	...
	for (int i = 0; i < size; i++)
		versh[i] = 0;
	cout << endl << "   Обход в глубину нерекурсивным способом списков смежности" << endl;
	cout << endl << "   Введите номер вершины, с которой хотите начать обход: ";
	num = 0;
	cin >> num;
